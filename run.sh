...
docker run --rm -it -e "REMOTE_TARGET_NAME=AMAZON" -e CLUSTER_HOST=amazon -e NODE_COUNT=2 -e AWS_ACCESS_KEY_ID=********* -e "AWS_SECRET_ACCESS_KEY=*********" -e REGION=us-east-1b -e "SSH_KEY_NAME=mac" -e VM_SIZE=t1.micro cakk/pmxdeploy:latest
