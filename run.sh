...
docker run --rm -it -e "REMOTE_TARGET_NAME=BBOX" -e CLUSTER_HOST=brightbox -e NODE_COUNT=4  -e "OPEN_PORTS=8080,3306" -e CLIENT_ID=******* -e CLIENT_SECRET=*************** -e VM_SIZE=nano cakk/pmxdeploy:latest
