...
docker run --rm -it -e ETCD_API=172.17.42.1:4001 -e CLUSTER_HOST=brightbox -e NODE_COUNT=1 -e CLIENT_ID=cli-q07lz -e CLIENT_SECRET=r2dnpu3uxdpb481 -e REGION=zon-qt3kk -e VM_SIZE=nano cakk/pmxdeploy:latest
